...
- [安装版](https://github.com/OldJii/mcp-dock/releases/latest/download/MCP.Dock.Setup.1.3.0.exe)
- [便携版](https://github.com/OldJii/mcp-dock/releases/latest/download/MCP.Dock.1.3.0.exe)
