...
- [Installer](https://github.com/OldJii/mcp-dock/releases/latest/download/MCP.Dock.Setup.1.1.0.exe)
- [Portable](https://github.com/OldJii/mcp-dock/releases/latest/download/MCP.Dock.1.1.0.exe)
